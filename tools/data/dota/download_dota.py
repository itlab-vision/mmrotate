...
DOTA_1_0_ITEMS = [
    ...
    ('train', 'train/images', 'train/images part_2',
     '1JBWCHdyZOd9ULX0ng5C9haAt3FMPXa3v'),
    ('train', 'train/images', 'train/images part_3',
    ...
    ('test', 'test/images', 'test/images part_2',
...
def mark_as_downloaded(manifest_path: Path, manifest_key: str):
    """Append a unique manifest key to the manifest file after successful
    extraction."""
...
def extract_and_place(archive_path: Path, target_dir: Path):
    """Extract .zip or .tar archive and move inner files to target
    directory."""
...
def process_version(gdown_module,
    ...
    for idx, (split_type, rel_target, display_name,
              file_id) in enumerate(filtered_items, 1):
