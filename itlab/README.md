...
- **[guides/slurm_execution.md](guides/slurm_execution.md)**: Slurm cluster job submission guide (`evaluate_models.slurm`), resource directives, partition overrides, and job control.
...
- **[benchmarks/README.md](benchmarks/README.md)**: Storage for evaluation benchmark results, raw JSON output logs (`raw_results/`), and consolidated Markdown comparison tables.
